        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="staticBackdropLabel">Edit Kategori Produk</h1>
                ...
                <div class="modal-body">
                    <form action="{{ route('kategori-produk.update', $item->id) }}" method="POST">
                        ...
                        @method('PUT')
                        <div class="mb-3">
                            <label for="nama_kategori" class="form-label">Name Kategori Produk</label>
                            <input type="text" class="form-control" id="nama_kategori" name="nama_kategori"
                                value="{{ $item->nama_kategori }}" placeholder="Kategori Produk" required>
                        </div>
